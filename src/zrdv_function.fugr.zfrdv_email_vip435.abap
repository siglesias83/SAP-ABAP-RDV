...
*--------------------------------------------------------------------*
  ...
  LOOP AT lt_grp_email INTO ls_grp_email.
    ...
    CONCATENATE '<p>'
                '    Segue erros processamento fatura dia: '  l_char '.'
                '</p>'
    ...
    TRY.
        ...
        CONCATENATE 'RDV - Erro aqruivo fatura:' ls_ztrdv-arquivo INTO gv_subject SEPARATED BY space.
      ...
      CATCH cx_bcs INTO gr_exception.
        ...
        CONCATENATE 'Email VIP435 -' return-message INTO return-message SEPARATED BY space.
        return-type = 'E'.
    ENDTRY.
  ENDLOOP.
